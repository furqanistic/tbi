  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="relative isolate overflow-hidden bg-white/40 dark:bg-primary/5 backdrop-blur-3xl px-8 py-20 rounded-[3.5rem] shadow-2xl border border-primary/10 sm:px-16 lg:px-24 group">
          ...
          <div className="relative space-y-8 text-center flex flex-col items-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/10 text-primary text-xs font-bold uppercase tracking-widest">
              <Sparkles className="w-3 h-3 fill-current" />
              Limited Seats Available
            </div>

            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground tracking-tight leading-[1.1]">
