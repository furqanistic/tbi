  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className="flex-1 min-w-[120px] h-7 border-0 bg-transparent p-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 text-sm placeholder:text-muted-foreground/60"
